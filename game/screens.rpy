...
screen main_menu():
    ...
    if gui.show_name:
        ...
        vbox:
            text "{bt}{size=50}{color=FFFF00}[config.name!t]{/bt}":
                style "main_menu_title"

            text "{color=FFFF00}[config.version]":
...
screen about():
    ...
    use game_menu(_("About"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Made with {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t] \n\nCreated by Daniel Westfall <SoDaRa2595@gmail.com>")
...
screen history():
    ...
    use game_menu(_("History"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0):
        ...
        ### ------- Where you want to update if you want your tags to apply in the history menu -------- ###
                $ what = renpy.filter_text_tags(h.what, allow=[gui.history_allow_tags, "bt"])
                text what:
                    substitute False
