...
- Implement `set_style()` and `set_style_prefix()` in every class you'd want this to apply to. Simply copy the examples provided in the block comment directly above BounceText in kinetic_text_tags.rpy.
